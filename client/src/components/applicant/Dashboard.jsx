      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="absolute" open={open} sx={{ backgroundColor: 'white', color: 'black', boxShadow: (theme) => theme.shadows[4] }}>
          <Toolbar sx={{ pr: '24px' }}>
            ...
            <Typography component="h1" variant="h6" color="inherit" noWrap sx={{ flexGrow: 1 }}>Applicant Dashboard</Typography>
            <Box sx={{ flexGrow: 0 }}>
              <Button
                startIcon={
                  profileImg ?
              ...
              >
                <MenuItem onClick={() => {handleCloseUserMenu(); navigate('/applicant/profile');}}>Profile</MenuItem>
                <MenuItem onClick={() => {handleCloseUserMenu(); navigate('/applicant/settings');}}>Settings</MenuItem>
                <Divider />
