        ...
        <Grid container spacing={4} justifyContent="center">
          <Grid item xs={12} sm={6} md={4}>
            <Paper elevation={3} sx={{ p: 4, minHeight: '250px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', borderRadius: '20px' }}>
              <img src={`${process.env.PUBLIC_URL}/assets/images/pic-1.svg`} alt="Job Positions" style={{ width: '50%', marginBottom: '1rem' }} />
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Paper elevation={3} sx={{ p: 4, minHeight: '250px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', borderRadius: '20px' }}>
              <img src={`${process.env.PUBLIC_URL}/assets/images/pic-2.svg`} alt="Recruitment Process" style={{ width: '50%', marginBottom: '1rem' }} />
              <Typography variant="h6" component="h3">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Paper elevation={3} sx={{ p: 4, minHeight: '250px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', borderRadius: '20px' }}>
              <img src={`${process.env.PUBLIC_URL}/assets/images/pic-3.svg`} alt="Candidate Profiles" style={{ width: '50%', marginBottom: '1rem' }} />
              <Typography variant="h6" component="h3">
